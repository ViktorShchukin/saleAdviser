...
2. Введение критериев проверки точности интерполяции. К примеру среднеквадратичное отклонение 
3. Введение поправочного коэффициента прогноза на основе кол-ва продаж того-же месяца предыдущих лет()

Я понял что поправочный коэффициент неоднозначная тема. Каким он должен быть? Возможно следует его отложить или получше разобраться в матстате 
...
Ввод реализаций методов аналитики данных. К 
примеру:
